...
<section class="page-title-area">
    ...
    <section class="terms-of-service-area ptb-70">
    <div class="container">
    <div class="row">
    <div class="col-lg-8 col-md-12">
    <div class="terms-of-service-content">
    <img src="assets/img/smalllogo.jpg" alt="image">
    <p><i>This Terms of Service was last updated on July 1, 2021.</i></p>
    <h3>1. Our Website</h3>
    <p>Our website address is: <strong>http://drodo.com</strong></p>
    <p>We collect certain data from you directly, like information you enter yourself, data about your participation in courses, and data from third-party platforms you connect with <strong>Drodo</strong>. We also collect some data automatically, like information about your device and what parts of our Services you interact with or spend time using.</p>
    ...
    <li class="active"><a href="{{url("/terms")}}">Terms of Service</a></li>
    </ul>
    </section>
    </aside>
    </div>
