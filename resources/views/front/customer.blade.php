...
<section class="page-title-area">
    ...
    <p>Drodo accepts the following payment methods:</p>
    <ul>
    ...
    <li>Drodo features a Fast Checkout option, allowing you to securely save your credit card details so that you don't have to re-enter them for future purchases.</li>
