            ...
            <div class="col-lg-7 col-md-12">
                <div class="products-details-desc">
                    ...
                    <ul class="products-info">
                        ...
                        <li><span>Products Type:</span> <a href="#">Book</a></li>
                    </ul>
                    ...
                    <div class="products-add-to-cart">
                        ...
                        <button type="submit" class="default-btn"><i class="flaticon-trolley"></i> Rent it</button>
                    </div>
                </form>
                                ...
                                <div class="accordion-content">
                                    ...
                                    <div class="products-review-comments">
                                        ...
                                        <div class="user-review">
                                            <img src="{{url('assets/img/shresth.jpeg')}}" alt="image">
                                            <div class="review-rating">
                                                ...
                                                <span class="d-inline-block">Shresth Arora</span>
                                            </div>
                                            <span class="d-block sub-comment">Excellent</span>
                                            <p>This Book Has Changed My Life.</p>
                                        </div>
                                        <div class="user-review">
                                            <img src="{{url('assets/img/vishal.jpeg')}}" alt="image">
                                            <div class="review-rating">
                                                <div class="review-stars">
                                                    <i class='bx bxs-star checked'></i>
                                                    <i class='bx bxs-star checked'></i>
                                                ...
                                                <span class="d-inline-block">Vishal Singh</span>
                                            </div>
                                            <span class="d-block sub-comment">Quality!</span>
                                            <p> Sometimes you just need some solitude!

                                            </p>
                                        </div>
                                        <div class="user-review">
                                            <img src="{{url('assets/img/nitish.jpeg')}}" alt="image">
                                            <div class="review-rating">
                                                <div class="review-stars">
                                                    <i class='bx bxs-star checked'></i>
                                                    <i class='bx bxs-star checked'></i>
                                                ...
                                                <span class="d-inline-block">Nitish Yadav</span>
                                            </div>
                                            <span class="d-block sub-comment">Perfect!</span>
                                            <p>I Loved This Book</p>
                                        </div>
                                        <div class="user-review">
                                            <img src="{{url('assets/img/ashish.jpeg')}}" alt="image">
                                            <div class="review-rating">
                                                <div class="review-stars">
                                                    <i class='bx bxs-star checked'></i>
                                                    <i class='bx bxs-star checked'></i>
                                                ...
                                                <span class="d-inline-block">Aashish Pandagre</span>
                                            </div>
                                            <span class="d-block sub-comment">Spectacular!</span>
                                            <p>This book is as good as everyone says.</p>
                                        </div>
                                    </div>
        ...
        <div class="container">
            ...
            <div class="products-slides owl-carousel owl-theme">
                ...
                <div class="single-products-box">
                    <div class="image">
                        <a href="#" class="d-block"><img src="{{url('/upload/'.$p->product_image)}}"
